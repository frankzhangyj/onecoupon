...
public interface CouponTemplateMapper extends BaseMapper<CouponTemplateDO> {
     ...
     * @return 是否发生记录变更
     */
    int incrementCouponTemplateStock(@Param("shopNumber") Long shopNumber, @Param("couponTemplateId") Long couponTemplateId, @Param("decrementStock") Integer decrementStock);
}
